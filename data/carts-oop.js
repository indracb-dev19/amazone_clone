// we can recreate object when we put it into a function
// a function name that obtain an object must use PascalCase rule name

function Cart(localStorageKey = 'cart-oop') {
  // move all the function and variable to an object
  const cart = {
    items: undefined,
    totalItem: 0,
